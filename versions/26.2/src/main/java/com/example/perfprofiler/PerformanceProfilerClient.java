...
public class PerformanceProfilerClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        toggleProfileKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.perfprofiler.toggle_profile",
                InputConstants.Type.KEYSYM,
                GLFW.GLFW_KEY_F9,
                CATEGORY
        ));
        writeReportKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (openConfigKey.consumeClick()) {
                client.gui.setScreen(new ProfilerConfigScreen(client.gui.screen()));
            }
        });
