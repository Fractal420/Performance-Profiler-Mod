...
public final class ProfilerHud {
    ...
    public static void render(GuiGraphics graphics, Minecraft client, SampleCollector sampler) {
        ...
        try {
            ...
            int y = 2;
            for (Line l : lines) {
                graphics.drawString(font, Component.literal(l.text), 4, y, l.color, true);
                y += font.lineHeight + 1;
            }
            ...
            try {
                graphics.drawString(font, Component.literal("Profiler HUD error"), 4, 4, 0xFFFF5555, true);
